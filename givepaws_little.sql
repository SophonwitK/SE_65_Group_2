...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2023 at 02:14 PM
...
CREATE TABLE `card` (
  ...
  `cardstatus` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `receipttype` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `receiptnumber` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `receiptimgpath` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
...
(25, 'ช่วยหมาผมด้วย', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).', '2023-04-01 14:21:15', 'waiting', 'ใบเสนอราคา', '4587A', 'img/receipt/QuotationNew.png', 40, 1, 'กรุงไทย', 'โสภณวิชญ์ ควันไชย', '277-887-8576'),
...
(35, 'dfadaqDSDSAW', 'DADAWDAWD', '2023-04-04 19:11:06', 'complete', 'ใบเสนอราคา', '15212', 'img/receipt/338717248_172433545265739_5864429397870140951_n.jpg', 45, 1, 'FESS', 'AWDAWDA', 'AWDAWDWADW'),
(36, 'adwaaw', 'awawawda', '2023-04-04 19:23:36', 'approve', 'ใบเสนอราคา', 'aadawdadwd', 'img/receipt/338717248_172433545265739_5864429397870140951_n_e1kAMBl.jpg', 45, 1, 'aadawda', 'awawwaad', 'adadawdawd'),
(37, 'dawawdaw', 'dawdwadawdawd', '2023-04-04 20:30:48', 'close', 'ใบเสนอราคา', 'awd', 'img/receipt/338717248_172433545265739_5864429397870140951_n_D8hdTf2.jpg', 45, 1, 'adawdadaw', 'dadawdada', 'dawdadd'),
(38, 'awddawdaad', 'dawddaadawdad', '2023-04-05 04:22:31', 'approve', 'ใบเสนอราคา', 'adwawdad', 'img/receipt/338717248_172433545265739_5864429397870140951_n_ZIW2SSL.jpg', 45, 1, 'adwadadaa', 'dawddadad', 'dwaadadad');
...
(12, '2023-04-04 19:29:14', 'ไพำไพไำก', 'พไ-ภไพ', 'img/donar/338717248_172433545265739_5864429397870140951_n.jpg', 36),
(13, '2023-04-05 05:46:55', 'ซักอย่าง', 'ทำอะไร', 'img/donar/338717248_172433545265739_5864429397870140951_n_oouANYM.jpg', 25);
...
CREATE TABLE `donatetopic` (
  ...
  `slipImgComplete` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(27, 34, 'ค่ารักษา', 4000, 'img/payment/complete/338717248_172433545265739_5864429397870140951_n.jpg', 'complete'),
(28, 34, 'ค่าอาหารหมา', 300, '', 'complete'),
(29, 35, 'ค่ารักษา', 23452, '', 'complete'),
(30, 36, 'ค่ารักษา', 999, '', 'complete'),
(31, 37, 'ค่ารักษา', 5909050, 'img/payment/complete/338717248_172433545265739_5864429397870140951_n_YeNW7PP.jpg', 'waiting'),
(32, 38, 'ค่ารักษา', 100, '', 'complete');
...
(53, 'img/card/338717248_172433545265739_5864429397870140951_n.jpg', 35),
(54, 'img/card/338717248_172433545265739_5864429397870140951_n_8kzl2wJ.jpg', 36),
(55, 'img/card/338717248_172433545265739_5864429397870140951_n_tWItkH4.jpg', 37),
(56, 'img/card/338717248_172433545265739_5864429397870140951_n_ERLzXnO.jpg', 38);
...
CREATE TABLE `paymentcard` (
  ...
  `date` datetime NOT NULL,
  `paymentcardimg` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `status` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `donatetopicID` int(20) NOT NULL,
  `comment` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(24, 43, 650, '2023-04-01 16:09:52', 'img/payment/12.jpg', 'approve', 13, NULL),
...
(30, 40, 50150, '2023-04-04 19:13:43', 'img/payment/338717248_172433545265739_5864429397870140951_n.jpg', 'approve', 29, NULL),
(31, 40, 1000, '2023-04-04 19:24:22', 'img/payment/338717248_172433545265739_5864429397870140951_n_1Mz4mco.jpg', 'approve', 30, NULL),
(32, 40, 440, '2023-04-04 19:25:12', 'img/payment/338717248_172433545265739_5864429397870140951_n_jUZbjYR.jpg', 'reject', 30, NULL),
(33, 40, 99999, '2023-04-04 20:06:01', 'img/payment/338717248_172433545265739_5864429397870140951_n_FHZQf3I.jpg', 'approve', 30, NULL),
(34, 40, 50, '2023-04-04 20:31:19', 'img/payment/335315043_230037266079708_2511818804944136584_n.jpg', 'approve', 31, NULL),
(35, 40, 10000000000000, '2023-04-04 20:36:31', 'img/payment/338717248_172433545265739_5864429397870140951_n_UG7HRTe.jpg', 'waiting', 31, NULL),
(36, 40, 50, '2023-04-05 04:25:08', 'img/payment/338717248_172433545265739_5864429397870140951_n_w0rZsxQ.jpg', 'approve', 32, NULL),
(37, 40, 50, '2023-04-05 04:25:22', 'img/payment/338717248_172433545265739_5864429397870140951_n_VnXJbEB.jpg', 'approve', 32, NULL);
...
(45, NULL, 0, '', '', 0, 1, '2023-04-04 19:08:26.599162', 'Little', 'Little@gmail.com', 'pbkdf2_sha256$390000$uAEbGnI6gNLJ0be2cl0f8X$NKQTIOm5nGQ/MTGGsHqss36BiiT3kC4G9x71KiZHxi8=', 'Little', 0, 0, 1),
(46, NULL, 0, '', '', 0, 1, '2023-04-04 19:09:06.703817', 'Little2', 'Little2@gmail.com', 'pbkdf2_sha256$390000$R4UKFIbp9xg5fbxRUZYniq$LFI9tdrtLZuJ8uDQr8KSaWmwU4JNaRRlIO7oJG/TMsA=', 'Little2', 1, 0, 0),
(47, NULL, 0, '', '', 0, 1, '2023-04-04 19:12:25.653883', 'Little4', 'Little4@gmail.com', 'pbkdf2_sha256$390000$FyZulwYaGcOekQHJjnl2jW$77UFAXvlaEVrqFVRw9xrRieIFMtkdXoBh9g0K5GUJAM=', 'Little4', 0, 0, 0);
...
--
ALTER TABLE `card`
  MODIFY `cardID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `donar`
  MODIFY `donarID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `donatetopic`
  MODIFY `donatetopicID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `paymentcard`
  MODIFY `paymentcardID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
