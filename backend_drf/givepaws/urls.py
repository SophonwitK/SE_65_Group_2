...
urlpatterns = [
    ...
    path("hc/<int:pk>",views.hc_detail,name="hc_detail"), #post and get all hc
    path("role/hc",views.user_hc_list,name="user_hc_list"), #post and get all hc
    ...
    path("topic/by/payment/<int:pk>/check/",views.topic_payment_check,name="topic_payment_check"),  ## 
